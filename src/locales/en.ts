  ...
  translation: {
    ...
    flyWithMeSections: [
      ...
      },
      {
        ...
        shortLabel: "Routes",
        paragraphs: [
          "Most flights are **1 to 1.5 hours** (~2h for Pyrenees). Favorite routes:",
          "🌊 **Coast:** Sabadell → Mataró → coastline towards Blanes/Lloret, then back.",
          "⛰️ **Montserrat / inland:** towards Igualada and Montserrat, optionally continuing to Sau/Montseny.",
          "🏔️ **Pyrenees:** longer flights towards La Seu d'Urgell/Cerdanya, stunning in winter.",
          "The route is **never 100% guaranteed**: on the day I check weather and we decide. If weather fails, **we cancel and find another day**.",
        ],
      },
      {
        emoji: "🕐",
      ...
      },
      {
        ...
        paragraphs: [
          "It's quite different from an airliner: noisier (we fly with headsets) and you feel air movements more.",
          "We usually fly **early morning or late in the day** when the air is calmest. The **coastal route is especially smooth**.",
          "If turbulence or nerves worry you, we can start with **a short flight** or turn back to Sabadell anytime without issue.",
          "During the briefing and flight I'll explain how the aircraft works and, weather permitting, let you try the controls.",
        ],
      },
      {
        emoji: "💰",
