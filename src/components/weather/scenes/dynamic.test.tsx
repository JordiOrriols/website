...
describe("DynamicScene", () => {
  ...
  it("renders rain elements when weather is rain", async () => {
    const { container } = render(<DynamicScene weather={"rain" as any} timeOfDay={"day" as any} />);
  ...
  it("renders snow when weather is snow", async () => {
    const { container } = render(<DynamicScene weather={"snow" as any} timeOfDay={"day" as any} />);
