    ...
    <>
      ...
      {ghosts.map((ghost) => (
        ...
        >
          ...
          >
            <g style={{ display: ghost.model === 1 ? "inherit" : "none" }}>
              <path
            ...
            <g style={{ display: ghost.model === 2 ? "inherit" : "none" }}>
              <path
            ...
            <g style={{ display: ghost.model === 3 ? "inherit" : "none" }}>
              <path
            ...
            <g style={{ display: ghost.model === 4 ? "inherit" : "none" }}>
              <path
            ...
            <g style={{ display: ghost.model === 5 ? "inherit" : "none" }}>
              <path
            ...
            <g style={{ display: ghost.model === 6 ? "inherit" : "none" }}>
              <path
